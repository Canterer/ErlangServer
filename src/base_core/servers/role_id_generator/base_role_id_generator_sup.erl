%% Description: TODO: Add description to base_role_id_generator_sup
-module(base_role_id_generator_sup).
...
%% --------------------------------------------------------------------
?init([ServerId]) ->
	RoleIdConfig = {base_role_id_generator_server,
						{base_role_id_generator_server,start_link,[ServerId]},
						permanent,2000,worker,[base_role_id_generator_server]},
